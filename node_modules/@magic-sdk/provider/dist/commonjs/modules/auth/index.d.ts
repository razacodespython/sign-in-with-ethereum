import { LoginWithMagicLinkConfiguration, RegisterWithWebAuthnConfiguration, LoginWithWebAuthnConfiguration } from '@magic-sdk/types';
...
export declare class AuthModule extends BaseModule {
    ...
    registerWithWebAuthn(configuration: RegisterWithWebAuthnConfiguration): Promise<string | null>;
    loginWithWebAuthn(configuration: LoginWithWebAuthnConfiguration): Promise<string | null>;
}
export {};
