...
var webauthn_1 = require("../../util/webauthn");
...
var AuthModule = /** @class */ (function (_super) {
    ...
    AuthModule.prototype.loginWithCredential = function (credentialOrQueryString) {
        ...
        if (!credentialOrQueryString && sdk_environment_1.SDKEnvironment.target === 'web') {
                ...
                switch (_b.label) {
                    case 0:
                        if (!window.PublicKeyCredential) {
                            throw sdk_exceptions_1.createWebAuthnNotSupportError();
                        }
                        username = configuration.username, _a = configuration.nickname, nickname = _a === void 0 ? '' : _a;
                        return [4 /*yield*/, this.request(json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.WebAuthnRegistrationStart, [{ username: username }]))];
                    case 1:
                        options = _b.sent();
                        _b.label = 2;
                    case 2:
                    ...
                    case 4:
                        err_1 = _b.sent();
                        throw sdk_exceptions_1.createWebAuthCreateCredentialError(err_1);
                    case 5: return [2 /*return*/, this.request(json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.RegisterWithWebAuth, [
                            {
                                id: options.id,
                                nickname: nickname,
                                transport: credential.response.getTransports(),
                                user_agent: navigator.userAgent,
                                registration_response: webauthn_1.transformNewAssertionForServer(credential),
                            },
                        ]))];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request(json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.LoginWithWebAuthn, [{ username: username }]))];
                    case 1:
                    ...
                    case 4:
                        err_2 = _a.sent();
                        throw sdk_exceptions_1.createWebAuthCreateCredentialError(err_2);
                    case 5: return [2 /*return*/, this.request(json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.WebAuthnLoginVerfiy, [
                            {
                                username: username,
                                assertion_response: webauthn_1.transformAssertionForServer(assertion),
                            },
                        ]))];
                }
            });
