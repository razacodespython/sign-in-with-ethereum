...
var UserModule = /** @class */ (function (_super) {
    ...
    UserModule.prototype.getWebAuthnInfo = function () {
        var requestPayload = json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.GetWebAuthnInfo, []);
        return this.request(requestPayload);
    };
    UserModule.prototype.updateWebAuthnInfo = function (configuration) {
        var id = configuration.id, nickname = configuration.nickname;
        var requestPayload = json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.UpdateWebAuthnInfo, [
            {
    ...
    UserModule.prototype.unregisterWebAuthnDevice = function (id) {
        var requestPayload = json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.UnregisterWebAuthDevice, [
            {
                webAuthnCredentialsId: id,
            },
        ]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request(json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.RegisterWebAuthDeviceStart, []))];
                    case 1:
                        options = _a.sent();
                        _a.label = 2;
                    case 2:
                    ...
                    case 5: return [2 /*return*/, this.request(json_rpc_1.createJsonRpcRequestPayload(types_1.MagicPayloadMethod.RegisterWebAuthDevice, [
                            {
                                nickname: nickname,
