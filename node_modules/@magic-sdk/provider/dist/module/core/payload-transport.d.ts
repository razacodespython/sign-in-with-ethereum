import { MagicIncomingWindowMessage, MagicOutgoingWindowMessage, JsonRpcRequestPayload, MagicMessageEvent } from '@magic-sdk/types';
import { JsonRpcResponse } from './json-rpc';
import { ViewController } from './view-controller';
interface RemoveEventListenerFunction {
    (): void;
}
export declare abstract class PayloadTransport {
    protected readonly endpoint: string;
    protected readonly encodedQueryParams: string;
    protected messageHandlers: Set<(event: MagicMessageEvent) => any>;
    /**
     ...
     */
    post<ResultType = any>(overlay: ViewController, msgType: MagicOutgoingWindowMessage, payload: JsonRpcRequestPayload[]): Promise<JsonRpcResponse<ResultType>[]>;
    post<ResultType = any>(overlay: ViewController, msgType: MagicOutgoingWindowMessage, payload: JsonRpcRequestPayload): Promise<JsonRpcResponse<ResultType>>;
    /**
