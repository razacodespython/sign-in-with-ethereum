 ...
 * @deprecated
 */
export declare function encodeQueryParameters<T = QueryParameters>(options: T): string;
/**
 * Given a Base64 JSON string, decode a JavaScript object.
 *
 * @deprecated
 */
export declare function decodeQueryParameters<T = QueryParameters>(queryString: string): T;
