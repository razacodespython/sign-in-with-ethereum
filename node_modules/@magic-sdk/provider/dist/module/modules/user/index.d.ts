import { GetIdTokenConfiguration, MagicUserMetadata, GenerateIdTokenConfiguration, UpdateEmailConfiguration, UpdateWebAuthnInfoConfiguration } from '@magic-sdk/types';
...
export declare class UserModule extends BaseModule {
    ...
    getWebAuthnInfo(): import("../..").PromiEvent<any[], {
        done: (result: any[]) => void;
        error: (reason: any) => void;
        settled: () => void;
    }>;
    updateWebAuthnInfo(configuration: UpdateWebAuthnInfoConfiguration): import("../..").PromiEvent<any[], {
        done: (result: any[]) => void;
        error: (reason: any) => void;
        settled: () => void;
    }>;
    unregisterWebAuthnDevice(id: string): import("../..").PromiEvent<any, {
        done: (result: any) => void;
        error: (reason: any) => void;
        settled: () => void;
    }>;
    registerWebAuthnDevice(nickname?: string): Promise<string | null>;
}
export {};
